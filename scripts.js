      ...
      emailjs.sendForm('contact_service', 'template_pujf54r', event.currentTarget, "user_VrEOLCVXUi06JSSqeXuqQ")
          .then(() => {
            //resets the form, button and displays resulting message to user
              ...
              $("#email-result").html("Message sent successfully! I'll get back to you as soon as possible.");
          }, (error) => {
              console.dir(error);
              $("#email-result").html("Sorry, this message couldn't be sent. Please get in contact with me through email directly.");
          });
  });
});
